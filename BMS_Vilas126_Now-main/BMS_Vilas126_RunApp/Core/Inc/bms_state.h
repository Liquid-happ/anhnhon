...
extern float    SOC;
extern float 		system_low_soc_alarm;
extern uint16_t sys_alarm_cell_ov_mv;
extern uint16_t sys_alarm_cell_uv_mv;
extern uint16_t sys_alarm_pack_ov_mv;
extern uint16_t sys_alarm_pack_uv_mv;
extern int16_t  sys_alarm_occ_10ma;
extern int16_t  sys_alarm_ocd_10ma;
extern int8_t   sys_alarm_otc_c;
extern int8_t   sys_alarm_otd_c;
extern int8_t   sys_alarm_utc_c;
extern int8_t   sys_alarm_utd_c;
extern int8_t   sys_alarm_eot_c;
extern int8_t   sys_alarm_eut_c;
extern int8_t   sys_alarm_otf_c;
extern uint16_t sys_alarm_cell_diff_mv;
